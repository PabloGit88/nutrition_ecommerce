	...
	<footer id="footer">
		...
		<div class="col-full">
        	...
        	<?php if( isset( $woo_options['woo_footer_right'] ) && $woo_options['woo_footer_right'] == 'true' ) {
				...
				<p><?php _e( 'Powered by', 'woothemes' ); ?> <a href="<?php echo esc_url( 'http://www.mafiashare.net' ); ?>">Wordpress</a>. <?php _e( 'Designed by', 'woothemes' ); ?> <a href="http://www.vectors4all.com"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/woothemes.png' ); ?>" width="74" height="19" alt="Woo Themes" /></a></p>
			<?php } ?>
			</div>
